...
sed -i 's|node_modules/@xterm/xterm/css|styles|g' term.html
sed -i 's|node_modules/@xterm/xterm/lib|js|g' term.html
sed -i 's|node_modules/@xterm/addon-fit/lib|js|g' term.html
